...
namespace MaterialDesignThemes.Wpf
{
    public static class GroupBoxAssist
    {
        ...
        public static void SetHeaderBorderBrush(DependencyObject element, Brush value)
        {
            element.SetValue(HeaderBorderBrushProperty, value);
        }

        public static Brush GetHeaderBorderBrush(DependencyObject element)
        {
            return (Brush)element.GetValue(HeaderBorderBrushProperty);
        }
        ...
        public static void SetHeaderBorderThickness(DependencyObject element, Thickness value)
        {
            element.SetValue(HeaderBorderThicknessProperty, value);
        }

        public static Thickness GetHeaderBorderThickness(DependencyObject element)
        {
            return (Thickness)element.GetValue(HeaderBorderThicknessProperty);
        }
        #endregion
